...
class TableViewControllerModel: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    let recipeBook = RecipeContainer()
...
//        let viewCont = self.storyboard.
    ...
    */
    ...
    func tableView(tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        //        recipeBook.cookBook.count
        return self.recipeBook.cookBook.count
    }
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell.textLabel.text = recipeBook.cookBook[indexPath.row].getTitle()
